      ...
      <section className="border-b border-gray-200 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-8 lg:py-24">
          <div className="flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between lg:gap-20">
            ...
            <aside className="w-full max-w-md rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:p-8" aria-label="Current product"><div className="flex items-center justify-between"><p className="text-xs font-bold uppercase tracking-wider text-gray-500">Currently building</p><span className="rounded-full bg-green-50 px-2.5 py-1 text-xs font-semibold text-green-700">Web app live</span></div><h2 className="mt-5 text-4xl font-bold tracking-tight text-gray-900">Resumely</h2><p className="mt-3 text-base leading-7 text-gray-600">An AI-powered resume and career platform that helps people present their work clearly.</p><a href="https://resumely.live" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-[#0D6EFD] hover:underline">Visit resumely.live <FiArrowUpRight aria-hidden="true" /></a><div className="mt-8 flex gap-6 border-t border-gray-200 pt-5"><div><p className="text-xl font-bold text-gray-900">3.5+</p><p className="mt-1 text-xs text-gray-500">Years experience</p></div><div><p className="text-xl font-bold text-gray-900">20+</p><p className="mt-1 text-xs text-gray-500">Projects shipped</p></div><div><p className="text-xl font-bold text-gray-900">AI</p><p className="mt-1 text-xs text-gray-500">Product focus</p></div></div></aside>
          </div>
        </div>
      </section>
